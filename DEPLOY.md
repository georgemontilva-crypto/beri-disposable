...
- [ ] Migraciones aplicadas — **automático**: el servidor las corre al arrancar (incluye `site_settings`, `newsletter_subscribers` las columnas de documentos y de datos de negocio en `wholesale_inquiries`, y `partner_news` + `partner_resources`)
